                            ...
                            <TableBody >
                                {cartItems?.map(cartItem => (
                                    <TableRow key={cartItem.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                        ...
                                        <TableCell> <h3 className='font-medium text-sm font-poppins text-[#222] sm_desktop:w-20 sm_desktop:text-[20px]' title='Single item price'> {`$${(cartItem.quantity * cartItem.price).toFixed(2)}`} </h3> </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
