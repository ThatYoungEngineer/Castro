      ...
      <div className="relative max-w-fit overflow-hidden group/overlay">
            ...
            <div className='hidden absolute bottom-5 group-hover/overlay:flex items-center justify-center gap-1 w-full animate__animated animate__slideInUp animate__faster'>
              ...
              <span className='w-fit h-fit'>
                <Button
                  ...
                  className='px-4 h-10
                  transition ease-in duration-300 hover:bg-red-500'
        ...
        { props.team ? 
          (
            <>
              <div 
                className="w-full h-full absolute z-20 top-0 left-0 bg-opacity-0 opacity-0 transition ease-linear duration-300
                group-hover/overlay:opacity-100 group-hover/overlay:bg-opacity-20 group-hover/overlay:bg-gray-500"
              >
              </div>
              <div
                className='hidden absolute z-30 bottom-10 left-[25%] right-[25%] group-hover/overlay:block'
              >
                <div
                  className='flex items-center justify-center gap-3
                  animate__animated animate__slideInUp animate__faster'
                >
                  <img className='w-14 h-14 p-5 bg-white hover:bg-red-500 transition ease-in duration-200 cursor-pointer' src={facebook} alt="" />
                  <img className='w-14 h-14 p-5 bg-white hover:bg-red-500 transition ease-in duration-200 cursor-pointer' src={linkedin} alt="" />
                  <img className='w-14 h-14 p-5 bg-white hover:bg-red-500 transition ease-in duration-200 cursor-pointer' src={xTwitter} alt="" />
                </div>
              </div>
            </>
          ) : (
